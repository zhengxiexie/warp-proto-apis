...
func (x *Request_Input_ToolCallResult) GetUploadFileArtifact() *UploadFileArtifactResult {
	if x != nil {
		if x, ok := x.xxx_hidden_Result.(*request_Input_ToolCallResult_UploadFileArtifact); ok {
...
func (x *Request_Input_ToolCallResult) SetUploadFileArtifact(v *UploadFileArtifactResult) {
	if v == nil {
		x.xxx_hidden_Result = nil
		return
	}
	x.xxx_hidden_Result = &request_Input_ToolCallResult_UploadFileArtifact{v}
}
...
func (x *Request_Input_ToolCallResult) HasUploadFileArtifact() bool {
	if x == nil {
		return false
	}
	_, ok := x.xxx_hidden_Result.(*request_Input_ToolCallResult_UploadFileArtifact)
	return ok
}
...
func (x *Request_Input_ToolCallResult) ClearUploadFileArtifact() {
	if _, ok := x.xxx_hidden_Result.(*request_Input_ToolCallResult_UploadFileArtifact); ok {
		x.xxx_hidden_Result = nil
	}
}
...
func (x *Request_Input_ToolCallResult) WhichResult() case_Request_Input_ToolCallResult_Result {
	...
	case *request_Input_ToolCallResult_UploadFileArtifact:
...
func (b0 Request_Input_ToolCallResult_builder) Build() *Request_Input_ToolCallResult {
	...
	if b.UploadFileArtifact != nil {
		x.xxx_hidden_Result = &request_Input_ToolCallResult_UploadFileArtifact{b.UploadFileArtifact}
	}
	return m0
}
...
type request_Input_ToolCallResult_UploadFileArtifact struct {
	UploadFileArtifact *UploadFileArtifactResult `protobuf:"bytes,33,opt,name=upload_file_artifact,json=uploadFileArtifact,oneof"`
}

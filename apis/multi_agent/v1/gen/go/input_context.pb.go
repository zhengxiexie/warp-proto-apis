...
type InputContext struct {
	...
	xxx_hidden_UpdatedLspServersContext *InputContext_LspServersContext `protobuf:"bytes,13,opt,name=updated_lsp_servers_context,json=updatedLspServersContext"`
...
func (x *InputContext) GetUpdatedLspServersContext() *InputContext_LspServersContext {
	if x != nil {
		return x.xxx_hidden_UpdatedLspServersContext
	}
	return nil
}
...
func (x *InputContext) SetUpdatedLspServersContext(v *InputContext_LspServersContext) {
	x.xxx_hidden_UpdatedLspServersContext = v
}
...
func (x *InputContext) HasUpdatedLspServersContext() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_UpdatedLspServersContext != nil
}
...
func (x *InputContext) ClearUpdatedLspServersContext() {
	x.xxx_hidden_UpdatedLspServersContext = nil
}
...
func (b0 InputContext_builder) Build() *InputContext {
	...
	x.xxx_hidden_UpdatedLspServersContext = b.UpdatedLspServersContext
...
type InputContext_LspServersContext struct {
	state                          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_AvailableLspServers *[]*LspDescriptor      `protobuf:"bytes,1,rep,name=available_lsp_servers,json=availableLspServers"`
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
func (x *InputContext_LspServersContext) GetAvailableLspServers() []*LspDescriptor {
	if x != nil {
		if x.xxx_hidden_AvailableLspServers != nil {
			return *x.xxx_hidden_AvailableLspServers
		}
	}
	return nil
}

func (x *InputContext_LspServersContext) SetAvailableLspServers(v []*LspDescriptor) {
	x.xxx_hidden_AvailableLspServers = &v
}

type InputContext_LspServersContext_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	AvailableLspServers []*LspDescriptor
}

func (b0 InputContext_LspServersContext_builder) Build() *InputContext_LspServersContext {
	m0 := &InputContext_LspServersContext{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_AvailableLspServers = &b.AvailableLspServers
	return m0
}
...
const file_input_context_proto_rawDesc = "" +
	...
	"\x15available_lsp_servers\x18\x01 \x03(\v2\".warp.multi_agent.v1.LspDescriptorR\x13availableLspServersB8Z.github.com/warp/warp-proto-apis/multi_agent/v1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
